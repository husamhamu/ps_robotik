...
def main(opt):
    ...
    rospy.Subscriber('string_message_topoic', String, callback)
    image_subscriber = rospy.Subscriber('/camera/image_rect_color', Image, image_callback)
    print('started spining')
    rospy.spin()
    print('doing other stuff')
    #run(source='/home/weilin/workspace/jetson-inference/python/training/detection/ssd/data/cubedetect/JPEGImages/20230615-065055.jpg')
